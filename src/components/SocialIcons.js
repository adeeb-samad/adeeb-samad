const SocialIcons = () => {
  return (
    <div className="socialIcons">
      <a className="icon" href="https://github.com/adeeb-samad">
        <i className="fa-brands fa-github" aria-label="Visit my Github account" title="Adeeb's GitHub Profile"></i>
      </a>
      <a className="icon" href="https://www.linkedin.com/in/adeeb-samad/">
